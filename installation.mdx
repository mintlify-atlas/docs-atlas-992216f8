...
description: "Add rules_xcodeproj to your Bazel workspace using Bzlmod. Covers MODULE.bazel setup, the module extension, and the resolved transitive dependency versions."
---
